...
namespace AlgorithmPrograms
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                int i, number;
                string[] programs = { "Anagram", "Prime Number", "AnagramPalindrome mix", " Algorithm StopWatch", "Guess game", "BinarySearch in File ", "Insertion Sort Line ", "Bubble Sort File int", "Merge Sort String", "Vending Machine", "Day of Week NEEDS COMMANDLINE ARGUMENTS 0 1 2", "Temprature convert", "Monthly Payment NEEDS COMMANDLINE ARGUMENTS 3 4 5", "Sqrt Newton", "to Binary", "Nibble binary" };
                do
                {
                    ...
                    Console.WriteLine("program : {0}", programs[number-1]);
                    switch (number)
                    {
                        case 0:
                            return;
                        case 1:
                            Utility.Anagram("mummy", "ymumm");
                            Console.ReadKey();
                            break;
                        case 2:
                        ...
                        case 12:
                            ...
                            break;
                        case 13:
                            Utility.MonthlyPayment(Convert.ToInt32(args[3]), Convert.ToInt32(args[4]), Convert.ToDouble(args[5]));
                            Console.ReadKey();
                            break;
                        case 14:
